    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'],
        function () {
            ...
            $("#doSearch").click(function () {
                ...
                $.post("${xq2580z}/check/checkRentExist", {
                    rentid: rentid
                }, function (obj) {
                    if (obj === "") {
            ...
            function initCheckFormData(rentid) {
                $.post("${xq2580z}/check/initCheckFormData", {rentid: rentid}, function (obj) {
                    //检查单
                    var check = obj.check;
                    ...
                    $("#car_carimg").attr("src", "${xq2580z}/file/downloadShowFile?path=" + car.carimg);
                })
            }
            ...
            form.on("submit(doSubmit)", function () {
                ...
                $.post("${xq2580z}/check/saveCheck", params, function (obj) {
                    layer.msg(obj.msg);
                    $("#content").hide();
                })
                return false;
