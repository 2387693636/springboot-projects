...
<script src="${xq2580z}/static/layui/layui.js"></script>
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'upload'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${xq2580z}/car/loadAllCar' //数据接口
            ...
            , cols: [[   //列表数据
                ...
                , {
                    field: 'carimg', title: '缩略图', align: 'center', width: '120', templet: function (d) {
                        return "<img width=40 height=30 src=${xq2580z}/file/downloadShowFile?path=" + d.carimg + " />";
                    }
                }
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${xq2580z}/car/loadAllCar?" + params,
                page: {
                    curr: 1
                }
            })
        ...
        table.on('tool(carTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.carnumber + '】这个车辆吗', function (index) {
                    //向服务端发送删除指令
                    $.post("${xq2580z}/car/deleteCar", {carnumber: data.carnumber}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function openAddCar() {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    $("#dataFrm")[0].reset();
                    //设置默认图片
                    $("#showCarImg").attr("src", "${xq2580z}/file/downloadShowFile?path=images/defaultcarimage.jpg")
                    $("#carimg").val("images/defaultcarimage.jpg")
                    url = "${xq2580z}/car/addCar";
        ...
        function openUpdateCar(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    $("#showCarImg").attr("src", "${xq2580z}/file/downloadShowFile?path=" + data.carimg);
                    url = "${xq2580z}/car/updateCar";
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的删除选中的这些车辆吗', function (index) {
                //向服务端发送删除指令
                $.post("${xq2580z}/car/deleteBatchCar", params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
        ...
        upload.render({
            elem: '#carimgDiv',
            url: '${xq2580z}/file/uploadFile',
            method: "post",  //此处是为了演示之用，实际使用中请将此删除，默认用post方式提交
            acceptMime: 'images/*',
            field: "mf",
            done: function (res, index, upload) {
                $('#showCarImg').attr('src', "${xq2580z}/file/downloadShowFile?path=" + res.data.src);
        ...
        function showCarImage(data) {
            ...
            mainIndex = layer.open({
                ...
                area: ['600px', '400px'],
                success: function (index) {
                    $("#view_carimg").attr("src", "${xq2580z}/file/downloadShowFile?path=" + data.carimg);
                }
            });
        }
    });
