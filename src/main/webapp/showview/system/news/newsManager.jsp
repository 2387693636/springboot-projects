...
<div style="display: none;" id="newsToolBar">
    ...
    <button type="button" class="layui-btn layui-btn-danger layui-btn-sm" lay-event="deletePartyNews">批量删除</button>
</div>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate', 'layedit'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${xq2580z}/news/loadAllNews' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${xq2580z}/news/loadAllNews?" + params,
                page: {curr: 1}
            })
        });
        ...
        table.on('tool(newsTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.title + '】这个公告吗', function (index) {
                    //向服务端发送删除指令
                    $.post("${xq2580z}/news/deleteNews", {id: data.id}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function deletePartyNews() {
            ...
            layer.confirm('真的删除选中的这些公告吗', function (index) {
                //向服务端发送删除指令
                $.post("${xq2580z}/news/deletePartyNews", params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
