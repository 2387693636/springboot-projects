...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${xq2580z}/customer/loadAllCustomer' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${xq2580z}/customer/loadAllCustomer?" + params,
                page: {
                    curr: 1
                }
            })
        ...
        $("#doExport").click(function () {
            var params = $("#searchFrm").serialize();
            window.location.href = "${xq2580z}/stat/exportCustomer?" + params;
        });
        ...
        table.on('tool(customerTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.custname + '】这个客户吗', function (index) {
                    //向服务端发送删除指令
                    $.post("${xq2580z}/customer/deleteCustomer", {identity: data.identity}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function openAddCustomer() {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    //清空表单数据
                    $("#dataFrm")[0].reset();
                    url = "${xq2580z}/customer/addCustomer";
                }
            });
        }
        ...
        function openUpdateCustomer(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url = "${xq2580z}/customer/updateCustomer";
                }
            });
        }
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的删除选中的这些客户吗', function (index) {
                //向服务端发送删除指令
                $.post("${xq2580z}/customer/deleteBatchCustomer", params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
