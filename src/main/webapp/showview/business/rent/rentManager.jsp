...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${xq2580z}/rent/loadAllRent' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${xq2580z}/rent/loadAllRent?" + params,
                page: {
                    curr: 1
                }
            })
        ...
        table.on('tool(rentTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.rentid + '】这个出租单吗', function (index) {
                    //向服务端发送删除指令
                    $.post("${xq2580z}/rent/deleteRent", {rentid: data.rentid}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
                ...
                window.location.href = "${xq2580z}/stat/exportRent?rentid=" + data.rentid;
            }
        });
