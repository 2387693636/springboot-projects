...
<div id="content" style="display: none;">
    ...
    <div id="carBar" style="display: none;">
        <a class="layui-btn layui-btn-xs layui-btn-warm" lay-event="rentCar">租赁自行车</a>
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function initCarData() {
            ...
            tableIns = table.render({
                ...
                , url: '${xq2580z}/car/loadAllCar?isrenting=0' //数据接口
                , title: '车辆据表'//数据导出来的标题
                , height: 'full-220'
                ...
                , cols: [[   //列表数据
                    ...
                    , {
                        field: 'carimg', title: '缩略图', align: 'center', width: '180', templet: function (d) {
                            return "<img width=40 height=40 src=${xq2580z}/file/downloadShowFile?path=" + d.carimg + " />";
                        }
                    }
        ...
        $("#doSearch").click(function () {
            ...
            $.post("${xq2580z}/rent/checkCustomerExist", params, function (obj) {
                if (obj.code >= 0) {
                    $("#content").show();
                    initCarData();
                } else {
        ...
        form.on("submit(doSubmit)", function (obj) {
            ...
            $.post("${xq2580z}/rent/saveRent", params, function (obj) {
                layer.msg(obj.msg);
                //关闭弹出层
