...
<script type="text/javascript" src="${xq2580z}/static/echarts/js/echarts.min.js"></script>
<script type="text/javascript" src="${xq2580z}/static/echarts/js/jquery-3.1.1.min.js"></script>
...
<script type="text/javascript">
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function getData() {
            ...
            $.get("${xq2580z}/stat/loadOpernameYearGradeStat", {year: year}, function (data) {
