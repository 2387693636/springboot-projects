...
<script type="text/javascript">
    ...
    function getLangDate() {
        ...
        document.getElementById("nowTime").innerHTML = "亲爱的${user.realname}，" + timeValue + "好！ 欢迎使用自行车在线租赁系统。当前时间为： " + newDate + "　" + week;
    ...
    layui.use(['form', 'element', 'layer', 'jquery'], function () {
        ...
        //最新文章列表
        $.get("${xq2580z}/news/loadAllNews?page=1&limit=10", function (data) {
            alert("data");
            var hotNewsHtml = '';
    ...
    function viewNews(id) {
        $.get("${xq2580z}/news/loadNewsById", {id: id}, function (news) {
            layer.open({
                type: 1,
                title: '查看公告',
