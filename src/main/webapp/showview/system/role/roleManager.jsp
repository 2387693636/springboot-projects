...
<head>
    ...
    <link rel="stylesheet" href="${xq2580z}/static/layui_ext/dtree/dtree.css">
    <link rel="stylesheet" href="${xq2580z}/static/layui_ext/dtree/font/dtreefont.css">
</head>
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    ...
    <script type="text/javascript">
        var tableIns;
        layui.extend({
            dtree: '${xq2580z}/static/layui_ext/dist/dtree'
            ...
            tableIns = table.render({
                ...
                , url: '${xq2580z}/role/loadAllRole' //数据接口
            ...
            $("#doSearch").click(function () {
                ...
                tableIns.reload({
                    url: "${xq2580z}/role/loadAllRole?" + params
                })
            });
            ...
            table.on('tool(roleTable)', function (obj) {
                ...
                if (layEvent === 'del') { //删除
                    layer.confirm('真的删除【' + data.rolename + '】这个角色吗', function (index) {
                        //向服务端发送删除指令
                        $.post("${xq2580z}/role/deleteRole", {roleid: data.roleid}, function (res) {
                            layer.msg(res.msg);
                            //刷新数据 表格
                            tableIns.reload();
                        })
            ...
            function deleteBatch() {
                ...
                layer.confirm('真的删除选中的这些角色吗', function (index) {
                    //向服务端发送删除指令
                    $.post("${xq2580z}/role/deleteBatchRole", params, function (res) {
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
            ...
            function openselectRoleMenu(data) {
                ...
                mainIndex = layer.open({
                    ...
                    yes: function (index, layero) {
                        ...
                        //保存角色和菜单的关系
                        $.post("${xq2580z}/role/saveRoleMenu", params, function (obj) {
                            layer.msg(obj.msg);
                        })
                    },
                    success: function (index) {
                        ...
                        menuTree = dtree.render({
                            ...
                            checkbarData: "choose",
                            url: "${xq2580z}/role/initRoleMenuTreeJson?roleid=" + data.roleid // 使用url加载（可与data加载同时存在）
                        });
                    }
                });
            }
