...
public class IPToolUtil {
    private static final Logger logger = Logger.getLogger("com.xq.system.utils.IPToolUtil");
    ...
    static {
        ...
        try {
            ...
            logger.severe("IPToolUtil error.");
            e.printStackTrace();
        }
        ...
        if (ip == null || ip.length() == 0 || "unknown".equalsIgnoreCase(ip)) {
            ...
            if (ip.equals("127.0.0.1")) {
                ...
                try {
                    ...
                    logger.severe("IPToolUtil error." + e.toString());
                }
            }
        }
        /**
